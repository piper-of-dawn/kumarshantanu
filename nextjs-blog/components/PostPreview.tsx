...
const PostPreview = (props: PostMetaData ) => {
  return (
      ...
      <div className="relative group hover:scale-105">
         <div className="absolute inset-2 bg-gradient-to-r rounded-md from-cyan-400 to-cyan-900 blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
